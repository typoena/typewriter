...
PCB = os.path.join(PROJ, "typoena-devboard.kicad_pcb")
SCH = os.path.join(PROJ, "typoena-devboard.kicad_sch")
DRU = os.path.join(PROJ, "typoena-devboard.kicad_dru")
PRO = os.path.join(PROJ, "typoena-devboard.kicad_pro")
