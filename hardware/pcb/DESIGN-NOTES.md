# Typoena — valeurs de conception et leur source
...
| Pont FB, R10 (VOUT→FB) | **56 kΩ** 1 % | calcul ci-dessous |
| Pont FB, R11 (FB→GND) | **7,5 kΩ** 1 % | idem |

VREF = 595 mV (PWM) → 0,595 × (1 + 56/7,5) = **5,04 V**, dans la fenêtre USB
4,75–5,25 V. Avec la tolérance de 1 % sur les deux résistances, la sortie reste entre
4,95 et 5,13 V. Les ~79 µA du pont sont sur le rail 5 V, coupé en veille : sans effet
sur le budget. Le 56 kΩ est mutualisé avec R26 et R27, les rappels CC de l'USB-C.
