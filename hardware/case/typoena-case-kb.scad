...
// base file's +4 and these left at 8.0 / 22 the caps drop from 3.1 mm proud of
// that wall to -0.9 and the back row sits in a well. Both carry the same +4, which
// restores 3.1 proud of the wall and 5.1 of the front rim exactly.
kb_post_h = 12.0;                // floor -> PCB bottom << VERIFY vs USB slot >>
Hk        = 26;                  // bay rim: hides the plate edge, caps sit proud
