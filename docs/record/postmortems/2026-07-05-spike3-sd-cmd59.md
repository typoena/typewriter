...
> firmware notes [`../../firmware/docs/bring-up-spikes.md`](../../../firmware/docs/bring-up-spikes.md).
> Spike program: [`sd_bench.rs`](../../../firmware/src/bin/sd_bench.rs).
...
- [x] Write up Spike 3 as verified in
      [`../../firmware/docs/bring-up-spikes.md`](../../../firmware/docs/bring-up-spikes.md) (2026-07-11).
...
- [ ] **Still open:** implement the FatFS atomic-save (unlink-then-rename +
      ...
      the crash-safe-writes item in [v0.9 robustness](../../plan/macroplan.md#v09--robustness--).
