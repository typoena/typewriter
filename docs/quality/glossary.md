...
1. **WHAT** — user-facing requirement; an outcome the user values.
   Lives in [`docs/qfd-house-1.md`](qfd-house-1.md) §1. Phrased as a sentence.
   Example: "Sub-second visible response to typing".

2. **Function** — a transformation the device performs (verb,
   input → output). Lives in [`docs/qfd-house-1.md`](qfd-house-1.md) §2's
...
3. **Characteristic** ≡ **HOW** — a measurable attribute of a
   ...
   [`docs/qfd-house-1.md`](qfd-house-1.md) §2's HOW table. Examples: latency,
...
- **Component** — subsystem that delivers one or more
  characteristics. Lives in [`docs/qfd-house-2.md`](qfd-house-2.md) §5.
- **ADR** — Architecture Decision Record ([`docs/adr.md`](../adr.md)).
